...
def inference_func(pathInput2, pathMask2, pathGT2, model_path):
    ...
    for i in range(0, length):
        ...
        flow, test_warp_image_primary, test_warp_mask_primary,test_mesh_primary = model.forward(test_input, test_mask)
        ...
        path = "result/Tps_mesh/" + str(i + 1).zfill(5) + ".jpg"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_model_name', type=str, default='model_无边界/distill_model_epoch200.pkl')
