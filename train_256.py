...
import numpy as np
from net.Flow_Distill_256 import FRKD
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str, default='./Fisheye_Image/')
    # parser.add_argument('--trainpath', type=str, default=['./DRC-D/training/'])
    # parser.add_argument('--testpath', type=str, default=['./DRC-D/testing/'])
    parser.add_argument('--dis_flow_path_Teacheriter3', type=str, default='./Fisheye_Image/training/distill_flow')
    ...
    parser.add_argument('--save_model_name', type=str, default='Fish_model/distill_model')
