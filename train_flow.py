...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str, default='./DRC-D/')
    # parser.add_argument('--trainpath', type=str, default=['./DRC-D/training/'])
    # parser.add_argument('--testpath', type=str, default=['./DRC-D/testing/'])
    parser.add_argument('--dis_flow_path_Teacheriter3', type=str, default='./DRC-D/training/distill_flow')
    ...
    parser.add_argument('--resume_epoch', type=int, default=199)
    print('<==================== Loading data ===================>\n')
